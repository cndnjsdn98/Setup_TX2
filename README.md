...
10. <del> Run a Python example to check that everything works:
```
cd ~/acados/examples/acados_python/getting_started
python ./minimal_example_ocp.py
```
Note that this may return `ModuleNotFoundError: No module named '_casadi'` as we have yet to install `CasADi` properly yet. </del>
